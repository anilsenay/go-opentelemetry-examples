...
import (
	...
	"github.com/anilsenay/go-opentelemetry-example-1/internal/models"
	"github.com/anilsenay/go-opentelemetry-example-1/pkg/tracer"
...
func (s *TodoService) GetTodos(ctx context.Context) ([]models.Todo, error) {
	...
	request, err := http.NewRequestWithContext(ctx, "GET", "http://localhost:3002/todos", nil)
	if err != nil {
...
func (s *TodoService) GetTodoById(ctx context.Context, id int) (models.Todo, error) {
	...
	request, err := http.NewRequestWithContext(ctx, "GET", fmt.Sprintf("http://localhost:3002/todo/%d", id), nil)
	if err != nil {
...
func doSomeWork(ctx context.Context) {
	defer tracer.Trace(&ctx, "doSomeWork")()
